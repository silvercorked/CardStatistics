...
public class Statistics {
	...
	public static <N extends Number> List<Tuple<Double, N>> approximateProbabilityDistribution(List<N> data) {
		List<Tuple<Integer, N>> frequencies = frequency(data);
		double size = data.size();
		List<Tuple<Double, N>> probabilityDistribution = new ArrayList<Tuple<Double, N>>();
		for (Tuple<Integer, N> frequencyOfN : frequencies)
			probabilityDistribution.add(new Tuple<Double, N>((((double) frequencyOfN.getFirst()) / size), frequencyOfN.getSecond()));
